...
The first time you run this code, you should install Spark by typing the following command into the console:

```{r eval=FALSE}
spark_install('3.3')
```
This only needs to be done once on the first run.

Next, we will install sparklyr and load up required packages.
